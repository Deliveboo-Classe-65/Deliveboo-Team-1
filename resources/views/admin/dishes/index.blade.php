...
@section('content')
      ...
      <table class="table">
        ...
        <tbody>
          @foreach ($dishes as $dish)
            <tr>
              <td>{!! $dish->visibility ? '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
  ...
  <path d="M3.35 5.47c-.18.16-.353.322-.518.487A13.134 13.134 0 0 0 1.172 8l.195.288c.335.48.83 1.12 1.465 1.755C4.121 11.332 5.881 12.5 8 12.5c.716 0 1.39-.133 2.02-.36l.77.772A7.029 7.029 0 0 1 8 13.5C3 13.5 0 8 0 8s.939-1.721 2.641-3.238l.708.709zm10.296 8.884-12-12 .708-.708 12 12-.708.708z"/>
              ...
              <td><a href="{{ route('admin.dishes.show', $dish->id) }}" type="button" class="btn btn-warning">Mostra</a></td>
              <td><a href="{{ route('admin.dishes.edit', $dish->id) }}" type="button" class="btn btn-info">Modifica</a></td>
              <td>
